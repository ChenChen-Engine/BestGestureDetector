 ...
 * 在[OnRotateListener.onRotate]或[OnTouchListener.onTouchMove]中调用，
...
abstract class RotateGestureDetector {
    ...
    /**
     * 处理移动手势，在[BestGestureDetector]的[OnRotateListener.onRotate]或[OnTouchListener.onTouchMove]中调用这个方法
     * @param detector 手势
     */
