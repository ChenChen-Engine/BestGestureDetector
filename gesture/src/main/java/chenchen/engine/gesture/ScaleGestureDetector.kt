 ...
 * 在[OnScaleListener.onScale]或[OnTouchListener.onTouchMove]中调用，
...
abstract class ScaleGestureDetector {
    ...
    /**
     * 处理移动手势，在[BestGestureDetector]的[OnScaleListener.onScale]或[OnTouchListener.onTouchMove]中调用这个方法
     * @param detector 手势
     */
